...
public class Ms_Kmh {
	...
	public static void main(String[] args) {
		...
		System.out.println("Faça um programa que leia uma velocidade em Km/h para milhas.");
		System.out.println();
		
		System.out.print("Digite a velocidade en milhas: ");
		float kmh = sc.nextFloat();
		
		double milhas = kmh / 1.61;
		...
		System.out.printf("A velocidade em Milhas é, %.4f%n", milhas);
